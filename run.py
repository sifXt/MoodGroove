...
client_credentials_manager = SpotifyClientCredentials('7a421eddb509417c89342220da777364','9a1345faa3294daa8ea17b733be7a2ab')
...
photo = PhotoImage(file="ml project\Music-recommendation-system-master\images\musicback.jpg")
...
df = pd.read_csv('ml project\Music-recommendation-system-master\Spotify Dataset Analysis\data.csv.zip', compression='zip')
...
image1 = Image.open("ml project\Music-recommendation-system-master\images\musicimg (1).jpg")
